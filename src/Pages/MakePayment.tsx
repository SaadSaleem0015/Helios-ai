  ...
  const fetchPaymentMethods = async () => {
    ...
    try {
      ...
      if (methods.length > 0) {
        ...
        const primaryMethod = methods.find((method) => method.is_primary);
        setSelectedPaymentMethod(primaryMethod || methods[0]);
      }
    } catch (error) {
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-primary text-white font-medium rounded-lg hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[140px]"
                  >
                    {loading ? (
                      <>
