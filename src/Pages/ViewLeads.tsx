...
export function ViewLeads() {
  ...
  async function deleteFile() {
    ...
    try {
      const response = await backendRequest("DELETE", `/files/${fileToDelete}`);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            onClick={uploadFile}
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary-dark transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          >
                  ...
                  <td colSpan={5} className="py-12 text-center">
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      ...
                      {!search && (
                        <button
                          onClick={uploadFile}
                          className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary-dark transition-colors"
                        >
                          <TbUpload className="w-4 h-4" />
                          Upload File
                        </button>
