    ...
    <div className="fixed inset-0 bg-gray-800/50  flex justify-center items-center p-12 z-90">
      <div className="bg-white py-6 px-6 md:px-10 rounded-lg shadow-lg max-w-full md:max-w-md w-full relative">
        ...
        <div className="flex justify-end space-x-4">
          <button
            className="border bg-white text-gray-950 text-base border-primary hover:bg-primary hover:text-white py-2 px-4 rounded-md transition duration-300"
            onClick={onClose}
          >
            Cancel
          </button>
          <button
            type="button"
            className={`bg-primary text-white py-2 text-base px-4 rounded-md transition duration-300 ${
              isFormValid() ? 'hover:bg-primary/80' : 'opacity-50 cursor-not-allowed'
            }`}
