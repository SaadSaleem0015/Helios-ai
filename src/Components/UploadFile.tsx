...
const navigate = useNavigate();
    async function handleUpload() {
        ...
        const response = await backendRequest("POST", "/files", data, {}, true);
    ...
    return (
        ...
        <div className="flex justify-end mt-6">
            <button
                ...
                className="w-24 sm:w-32 md:w-40 lg:w-48 py-2.5 text-sm bg-primary-dark text-white rounded-lg hover:bg-primary-dark transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50"
            >
                Upload
            </button>
        </div>
