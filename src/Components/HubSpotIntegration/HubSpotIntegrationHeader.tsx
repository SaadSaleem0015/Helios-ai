...
interface HubSpotIntegrationHeaderProps {
  checkingConnection: boolean;
  isHubSpotConnected: boolean;
}

export function HubSpotIntegrationHeader({ checkingConnection, isHubSpotConnected }: HubSpotIntegrationHeaderProps) {
  return (
    <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent px-6 py-5 border-b border-gray-200">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-bold text-gray-900">HubSpot CRM Integration</h2>
          <p className="text-sm text-gray-600 mt-0.5">Connect your HubSpot CRM to fetch leads automatically</p>
        </div>
      </div>
      ...
      <div className="mt-4">
        {checkingConnection ? (
          ...
          <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
            ...
            <div>
              <span className="text-sm font-semibold text-green-800 block">HubSpot CRM is connected</span>
              <span className="text-xs text-green-700">You can now fetch leads from your HubSpot account</span>
            </div>
          </div>
        ) : (
          <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg">
            ...
            <div>
              <span className="text-sm font-semibold text-yellow-800 block">HubSpot CRM is not connected</span>
