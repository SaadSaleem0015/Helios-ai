      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-auto">
        ...
        <div className="flex gap-3 p-4 sm:p-6 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl">
          ...
          <button
            ...
            className="flex-1 px-4 py-3 bg-primary hover:bg-primary-dark text-white rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {buttonText}
          </button>
        </div>
